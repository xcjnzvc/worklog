...
// [DYNAMIC IMPORTS] 초기 로딩 성능을 위해 컴포넌트 분리
const TeamAttendanceCard = dynamic(
  () => import("../_components/owner/TeamAttendanceCard"),
  { ssr: false },
);
const MonthlyAttendanceSummaryCard = dynamic(
  () => import("../_components/owner/MonthlyAttendanceSummaryCard"),
  { ssr: false },
);
const OwnerWeeklyScheduleCard = dynamic(
  () => import("../_components/owner/OwnerWeeklyScheduleCard"),
  { ssr: false },
);
const ManagementMenuCard = dynamic(
  () => import("../_components/owner/ManagementMenuCard"),
  { ssr: false },
);
const ActionCenterCard = dynamic(
  () => import("../_components/owner/ActionCenterCard"),
  { ssr: false },
);
const InviteModal = dynamic(() => import("../_components/owner/InviteModal"), {
  ssr: false,
});
