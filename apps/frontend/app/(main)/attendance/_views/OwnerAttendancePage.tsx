          ...
          <div className="bg-white rounded-[24px] p-8 w-full max-w-[400px] space-y-4 shadow-xl">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 border border-gray-200 rounded-xl text-sm font-bold text-[#707EAE] bg-gray-50 hover:bg-gray-100 transition"
              >
                취소
              </button>
              <button
                ...
                className="flex-1 py-3 bg-[#EE5D50] hover:bg-[#d64f43] text-white rounded-xl text-sm font-bold transition shadow-sm"
              >
                반려 확인
              </button>
            </div>
