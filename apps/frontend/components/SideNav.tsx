...
export default function SideNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-[240px] h-screen bg-white border-r border-[#EEEEEE] flex flex-col p-[20px]">
      {/* 로고 영역 */}
      <h1 className="text-[24px] font-bold text-[#0023A1] mb-10 px-4">
        WorkLog
      </h1>
      ...
      {/* 하단 프로필 영역 */}
      <div className="relative mt-auto mb-[30px]">
        {popupOpen && (
          <div className="absolute bottom-full mb-2 left-0 w-full bg-white border border-[#EEEEEE] rounded-[16px] shadow-lg p-[16px] flex flex-col gap-[12px]">
            <div className="flex flex-col gap-[4px] pb-[12px] border-b border-[#EEEEEE]">
              <span className="text-[12px] text-[#999] bg-[#F5F5F5] rounded-full px-[8px] py-[2px] w-fit">
                {roleLabel}
              </span>
