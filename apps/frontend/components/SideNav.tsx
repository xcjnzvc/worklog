...
// import { useUserStore, User } from "@/store/useUserStore"; // User 타입 임포트
...
//   return (
//     <ul className="flex flex-col gap-2 flex-1 overflow-y-auto mt-10">
//       {menus.map((menu) => {
...
//   user: User | null; // any 대신 명확한 타입 사용
//   clearUser: () => void;
//   logout: () => void;
// }
...
//   return (
//     <div className="relative mt-auto mb-[30px] w-full">
//       {popupOpen && (
...
//         className="w-full rounded-[16px] p-[12px] hover:bg-[#F5F7FF] transition-colors focus:outline-none border border-gray-100"
//       >
//         <UserProfileItem
//           name={user?.name ?? "사용자"}
...
//   return (
//     <>
//       {/* 모바일 상단 헤더: lg(데스크탑)에서는 공간 자체가 hidden으로 사라짐 */}
...
//       {/* 모바일 Drawer: 오른쪽(right-0)에서 슬라이드 인 */}
//       <div
//         className={`
...
//       {/* 데스크탑 사이드바: lg 미만에서는 아예 렌더링되지 않아 여백 문제 해결 */}
//       <nav className="hidden lg:flex fixed top-0 left-0 w-[240px] h-screen bg-white border-r border-[#EEEEEE] flex-col p-[20px] z-[30]">
